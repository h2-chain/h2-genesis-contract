...
contract SlashIndicator is ISlashIndicator, System, IParamSubscriber {
    ...
    // The proper values depends on chain network's tolerance for continuous missing blocks.
    ...
    uint256 public constant INIT_FELONY_SLASH_SCOPE = 115200; // 1 days(block number)
