...
interface ValidatorSet {
    ...
    function INIT_NUM_OF_PROTONS() external view returns (uint256);
    ...
    function maxNumOfNeutrons() external view returns (uint256);

    function maxNumOfMaintaining() external view returns (uint256);

    function maxNumOfWorkingNeutrons() external view returns (uint256);
